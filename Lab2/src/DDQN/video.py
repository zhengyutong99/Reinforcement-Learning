...
if __name__ == "__main__":
    ...
    env = gym.wrappers.RecordVideo(env, 'DDQN-video')
    
    model = AtariNetDQN(env.action_space.n)
    model.load_state_dict(torch.load("/home/zhengyutong/data/Reinforce_Learning/Lab2/DDQN/log/model_2826207_4456.pth"))
    evaluate(env, model)