...
if __name__ == "__main__":
    ...
    while reward < 7500:
        ...
        env = gym.wrappers.RecordVideo(env, 'DQN-video')
        
        model = AtariNetDQN(env.action_space.n)
        model.load_state_dict(torch.load("/home/zhengyutong/data/Reinforce_Learning/Lab2/DQN/log/model_8217928_5006.pth"))
